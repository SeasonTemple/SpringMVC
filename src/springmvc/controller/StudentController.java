...
public class StudentController {
    ...
    public String pageList(@RequestParam(defaultValue="1",required=true,value="pageNo") Integer pageNo, Model model, HttpServletRequest request){
		return studentService.pageList(pageNo, model, request);
    }
}
