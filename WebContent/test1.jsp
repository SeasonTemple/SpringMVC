                    ...
                    <div class="navbar-fixed-top navbar-inverse">
                        <div class="navbar-header">
                            <a class="navbar-brand">
                                <div class="btn btn-default-lg" id="toggle-sidebar" data-placement="sbar" data-toggle="slidebar" title="侧边栏菜单"><em class="glyphicon glyphicon-th-large" style="color: rgba(155, 155, 155, 3)" id="navmenu"></em> 点击
                            </div>
                            </a>
                        </div>
