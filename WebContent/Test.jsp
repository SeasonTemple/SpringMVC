...
<body bgcolor="#615650">
	...
	<div id="test">
		<div id="Layer1"
			...
			<img id="myimage" src="resources/image/timg.jpeg" height="100%"
				width="100%" />
		</div>
		<form id="staff_info" action="" method="post">
			<fieldset style="text-align: center">
				...
				<table>
					<tr>
						<th>Name:</th>
						<th><input type="text" placeholder="......your_name"
							required="required"></th>
					</tr>
					<tr>
						<th>Email:</th>
						<th><input type="text" placeholder="......your_email"
							required="required"></th>
					</tr>
					<tr>
						<th>Birth:</th>
						<th><input type="text" placeholder="......your_birth"
							required="required"></th>
					</tr>
					<tr>
						<th colspan="2" style="text-align: center;"><input
							type="submit" value="submit" id="1">&nbsp;&nbsp;&nbsp;&nbsp;
